...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA5     ------> ADC1_IN5
    */
    HAL_GPIO_DeInit(GPIOA, U_Heater_Meas_Pin|U_POWER_Meas_Pin|CurrMeas1_A_Pin|CurrMeas1_B_Pin
                          |CurrMeas2_A_Pin|CurrMeas2_B_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PC3     ------> ADC2_IN13
    */
    HAL_GPIO_DeInit(GPIOC, TempMeas1_Pin|TempMeas2_Pin|TempMeas3_Pin|TempMeas4_Pin);
